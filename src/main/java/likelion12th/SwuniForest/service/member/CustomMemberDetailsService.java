...
public class CustomMemberDetailsService implements UserDetailsService {
    ...
    // 6번
    public UserDetails loadUserByUsername(String studentNum) {
    ...
    private UserDetails createUserDetails(Member member) {
        ...
        return new User(member.getStudentNum(), member.getPassword(), Collections.singletonList(grantedAuthority));
    }
